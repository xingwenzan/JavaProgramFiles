...
public abstract class BasicCard {
     ...
     */
    protected ArrayList<String> exAffixes;

    /**
     * 移除词缀表：<br/>
     * 受某些卡牌效果影响，使得该卡尽管名字有该词缀，但仍可视为不含有一部分词缀
     */
    protected ArrayList<String> reAffixes;
     ...
     * 1-2 如果该卡目前不含该词缀，将其添加到额外词缀表里。<br/>
     * 2 备注：终态方法，不可重写
     *
     * @param affixes 添加的词缀
     */
    protected final void addAffixes(String affixes) {
     ...
     * 1-2 如果该卡本身含有该词缀，将其添加到移除词缀表里。<br/>
     * 2 备注：终态方法，不可重写
     *
     * @param affixes 移除的词缀
     */
    protected final void removeAffixes(String affixes) {
